...
export class MapaPage implements OnInit {
  ...
  ionViewDidEnter() {
    ...
    let message = {
      ...
      body: 'Sabemos que nos queda mucho por mejorar y por eso necesitamos tu opinión y saber cómo has usado la herramienta para seguir creciendo.',
      ...
      link_title: 'Completar encuesta (5 min.)',
    };
